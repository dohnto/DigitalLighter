...
import com.example.digitallighter.R;
...
/**
 * This utility listens for mDNS multicast activity on the local network, and allows the user to submit their
 * own mDNS multicast queries.
 * 
 * @author simmons
 */
public class MulticastTestActivity extends Activity implements OnEditorActionListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		hostBox.setText("_http._tcp.local");
	}

	/**
	 * This is called when the user resumes using the activity after using other programs (and at activity
	 * creation time).
	 * 
	 * We don't keep the network thread running when the user is not running this program in the foreground,
	 * so we use this method to initialize the packet list and start the network thread.
	 */
	@Override
	...
	/**
	 * This is called when the user leaves the activity to run another program. We stop the network thread
	 * when this happens.
	 */
	@Override
