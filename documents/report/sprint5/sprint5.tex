...
Inability of clients to synchronize blinking commands, led to new round of debugging. After the changes described in Section XX.YY.ZZ new set of test have been executed. 
