...
This report is the delivery of the course, and it will be presented to an examiner at the end of the semester. It is also the most important part of the project, and it contains all the documentation for this project, everything from planning to the evalation and conclusion. In the table \ref{tab:structure_of_report} on page \pageref{tab:structure_of_report} it is possible to see the structure and the contents of this report.
