...
\subsection{Git}
The team adopted Git as its version control system since early phase.
...
Since merging conflicts can be sometimes demanding and usually requires a lot of knowledge of merging code, some issues occurred.
