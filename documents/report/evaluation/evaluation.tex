...
\subsection{Customer} 
"TODO"
The customer explained what they needed, and what the situation the application
would be used in, very clearly. It was noticeable that the customer had nothing at
steak in this project. They did not require regularly updates, and was otherwise
very busy with things not related to this project. This has not been a problem, but
the group think that this made this project being less realistic than in a "real life"
project
\subsection{Supervisor}
"TODO"
The supervisors gave us feedback on how the group's progress was compared to how
much should have been done in the time that had passed. It was quite useful to
know whether the group needed increase the work speed. The supervisors also gave
feedback on the content of the report. This was useful since the group did not know
what should be in the report and how it should be written.
...
\subsubsection{Time and time estimation}
"TODO"
