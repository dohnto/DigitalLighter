...
Since the team us using ScrumBut the roles were adapted a bit. We chose to rename the product owner to be communication responsible. The reason for this is  since it is not only a custmoer to continuously keep contact with, but also a supervisor. The team decided to be more spesific for some of the role, and not just use "the team". An we also wanted to have a role for quality assurance. 

When the team assign roles it was done according to members' skills and previous experience. 
