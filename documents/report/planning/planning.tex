...
Nevertheless we use only few roles and the responsibility of unused roles (mentioned in compendium) are distributed to all members. 
The bottom line is that as a development team were we are all equal.
