...
The risk table 3.3, taken from the risk management section in the planning chapter, shows many different risk that can occur. For this sprint most of them did not occur. 
This is still because we haven't gotten to the hardest technical parts yet, which is the image processing. This is scheduled for sprint 3. 

The user stories for this sprint was also very clear, and really not that different from the last sprint. The only difference was that instead of one client, we now have several clients connected to the server. As mentioned earlier the customer was very happy with the demonstration in sprint 1, and he let us choose the stories for this sprint ourselves. He approved of the stories we chose, and because of this we did not experience changes in the requirements in the last minute.
 
In this sprint the team also did a better job with the time estimation. All of this avoids a lot of issues, which is good. 
