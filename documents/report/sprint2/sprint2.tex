...
Contrarily to the previous sprint the customer decided to choose the user stories from the backlog for the next sprint himself. He again suggested the time estimation for specific stories that he considered to be of the greater difficulty. 

- bonus stories
- image processing only use existing solutions
- compulsory requirements = approved
- feedback about UML diagrams = not to violate rules
- simplify use case diagram
- added a few stories = server should process both mock and real world data
