...
Next, development technologies in Section \ref{sec:development_technologies}, project management tools in Section \ref{sec:management_tools}, version control tool choice in Section \ref{sec:vcs} communication in Section \ref{sec:communication_tools} and documentation tools in Section\ref{sec:documentation_tools} are presented.
