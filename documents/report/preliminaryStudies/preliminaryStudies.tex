...
It is impossible to have the crystal clear image of the resulting product in the beginning\cite{fairley2009managing} and this fact prevents both the customer and development team to specify all of the requirements beforehand. On the contrary it is more desirable to follow the employ the methodology which enables the development team to add the new features in an iterative manner and to present functional pieces of code (prototypes) to the customer regularly so that the right course of the project can be maintained.

Therefore it is reasonable to 

it has been decided to utilize the agile methodology, specifically the Scrum model as described in the following sections.

- lightweight


- we chose agile because (why)
	- suites our needs better
	- ...

A few of leading methodologies below. There will be presented 
