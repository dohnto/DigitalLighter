...
You can see a picture of Gravity's features in image \ref{fig:gravity}. After a while it showed up that Gravity has some bugs since it is in Beta version and it also lack a time tracking feature.
...
You can see example of board in TargetProcess3 in image \ref{fig:targetp}. Despite its complexity it has been decided by the team to use the TargetProcess as it suited the team's needs the best.
