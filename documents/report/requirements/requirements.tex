...
To achieve accessibility team plan to release the product on the Android Play Store\footnote{"https://play.google.com/store"} and thus enable everyone with Android device to try it. Use of TestFlight\footnote{https://testflightapp.com/} will allow easy access to application during implementation process for potential beta testers.
