...
In every sprint we will work on new features, or add more details to the previous ones. After discussing this with our customer we decided that two weeks is a suitable length for the sprints. All of the developers will work in each sprint. In every sprint the team will also continuously work on the report.  
